...
function setIcons() {
    ...
    $(".battery").append("<div class='footer'><(".battery")></i></div>");
...
function renderSlider(e) {
    ...
    e.append("<div class='slider-container'><div class='full-width-slider'><input value='" + e.attr("data-level") + "' min='1' max='10' type='range' step='1' data-mini='true' data-popup-enabled='true' data-disabled='" + readOnlyMode + "' data-highlight='true'></div></div>").find("input").slider();
...
function doPoll(e) {
    ...
    $.get("ping", n).done(function(t) {
        ...
        if (e) {
            ...
            if (t.status == "update") {
                for (i in t.data) updateTile(t.data[i])
            }
        }
    }).fail(function() {
        setWTFCloud()
...
function updateTile(e) {
    if (e.tile == "device") {
        ...
        if (e.type == "music") {
            if (e.trackDescription != t.attr("data-track-description") || e.mute + "" != t.attr("data-mute")) spinner(t);
            t.attr("data-track-description", e.trackDescription);
            if (e.mute + "" != t.attr("data-mute")) t.toggleClass("muted");
            t.attr("data-mute", e.mute);
            t.find(".title .track").html(t.attr("data-track-description"))
        }
        if (e.tile == "weather") {
...
$(function() {
    ...
    $(".music .play").click(function() {
        var e = $(this).closest(".tile");
        $(this).closest(".tile").toggleClass("active");
        sendCommand("music", e.attr("data-device"), "play")
    });
    $(".music .pause").click(function() {
        var e = $(this).closest(".tile");
        $(this).closest(".tile").toggleClass("active");
        sendCommand("music", e.attr("data-device"), "pause")
    });
    $(".music .muted").click(function() {
        var e = $(this).closest(".tile");
        $(this).closest(".tile").toggleClass("muted");
        sendCommand("music", e.attr("data-device"), "unmute")
    });
    $(".music .unmuted").click(function() {
        var e = $(this).closest(".tile");
        $(this).closest(".tile").toggleClass("muted");
        sendCommand("music", e.attr("data-device"), "mute")
    });
    $(".music .back").click(function() {
        var e = $(this).closest(".tile");
        sendCommand("music", e.attr("data-device"), "previousTrack")
    });
    $(".music .forward").click(function() {
        var e = $(this).closest(".tile");
        sendCommand("music", e.attr("data-device"), "nextTrack")
    });
